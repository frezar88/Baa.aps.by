...
const ListItemBrandFirst = (props) => {
    ...
    return (
        ...
        <li className={' align-items-center pb-2 '} style={{display: 'grid',gridGap:'10px', gridTemplateColumns: '40px 1fr 1fr'}}>
            ...
            </Form.Select>
            {
                props.valueBrand
                ?
                    <Form.Select style={{maxWidth: '196px'}} value={props.valueModel} className={'compare_select_brand ps-4 pe-5'}
...
export default ListItemBrandFirst;
