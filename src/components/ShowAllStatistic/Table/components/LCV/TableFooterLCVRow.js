    ...
    useEffect(() => {
        ...
        if (props.load) {
            ...
            if (props.stateYear == PREVIOUS_YEAR_MONTH.january) {
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.january}"]`, setStateJanuary)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.february}"]`, setStateFebruary)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.march}"]`, setStateMarch)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.april}"]`, setStateApril)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.may}"]`, setStateMay)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.june}"]`, setStateJune)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.july}"]`, setStateJuly)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.august}"]`, setStateAugust)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.september}"]`, setStateSeptember)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.october}"]`, setStateOctober)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.november}"]`, setStateNovember)
                setSum(`.lcv_body div[data-mount-id="${PREVIOUS_YEAR_MONTH.december}"]`, setStateDecember)
                // setSum('.model_body div.countYear', setStateTotal)
            }
            if (props.stateYear == YEAR_MONTH_2020.january) {
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.january}"]`, setStateJanuary)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.february}"]`, setStateFebruary)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.march}"]`, setStateMarch)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.april}"]`, setStateApril)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.may}"]`, setStateMay)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.june}"]`, setStateJune)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.july}"]`, setStateJuly)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.august}"]`, setStateAugust)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.september}"]`, setStateSeptember)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.october}"]`, setStateOctober)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.november}"]`, setStateNovember)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2020.december}"]`, setStateDecember)
                // setSum('.model_body div.countYear', setStateTotal)
            }
            if (props.stateYear == YEAR_MONTH_2019.january) {
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.january}"]`, setStateJanuary)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.february}"]`, setStateFebruary)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.march}"]`, setStateMarch)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.april}"]`, setStateApril)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.may}"]`, setStateMay)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.june}"]`, setStateJune)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.july}"]`, setStateJuly)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.august}"]`, setStateAugust)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.september}"]`, setStateSeptember)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.october}"]`, setStateOctober)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.november}"]`, setStateNovember)
                setSum(`.lcv_body div[data-mount-id="${YEAR_MONTH_2019.december}"]`, setStateDecember)
                // setSum('.model_body div.countYear', setStateTotal)
            }
        }
