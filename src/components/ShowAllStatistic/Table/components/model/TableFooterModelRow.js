...
const TableFooterModelRow = (props) => {
        ...
        useEffect( () => {
                ...
                if (props.load) {
                        ...
                        setSum('.model_body div[data-mount-id="1609448400"]', setStateJanuary)
                        setSum('.model_body div[data-mount-id="1612126800"]', setStateFebruary)
                        setSum('.model_body div[data-mount-id="1614546000"]', setStateMarch)
                        setSum('.model_body div[data-mount-id="1617224400"]', setStateApril)
                        setSum('.model_body div[data-mount-id="1619816400"]', setStateMay)
                        setSum('.model_body div[data-mount-id="1622494800"]', setStateJune)
                        setSum('.model_body div[data-mount-id="1625086800"]', setStateJuly)
                        setSum('.model_body div[data-mount-id="1627765200"]', setStateAugust)
                        setSum('.model_body div[data-mount-id="1630443600"]', setStateSeptember)
                        setSum('.model_body div[data-mount-id="1633035600"]', setStateOctober)
                        setSum('.model_body div[data-mount-id="1635714000"]', setStateNovember)
                        setSum('.model_body div[data-mount-id="1638306000"]', setStateDecember)
                        setSum('.model_body div.model-count-year', setStateTotal)
                }
